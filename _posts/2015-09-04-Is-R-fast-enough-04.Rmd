...
Note, in this case, the C++, using [Rcpp sugar](http://gallery.rcpp.org/articles/random-number-generation/) was the fastest, `r round(1/(sumLoops[8]/sumLoops[7]),2)`x faster.
