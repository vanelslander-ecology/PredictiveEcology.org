...
2. using [data.table](http://cran.r-project.org/web/packages/data.table/index.html) on integers is `r round((1-1/(mbInteger$relative[grep(as.character(mbInteger$test), pattern="stl_sort")]/mbInteger$relative[grep(as.character(mbInteger$test), pattern="data.table")]))*100)`% faster than the `C++` standard library sort.
