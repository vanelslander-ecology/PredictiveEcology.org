...
library(knitr)
knittingToHTML <- opts_knit$get("rmarkdown.pandoc.to")!="latex"
knittingToPDF <- !knittingToHTML
```
...
```{r printinga, eval=knittingToHTML, echo=FALSE,out.extra='style="float:right; margin: 20px; height: 200px; width: 200px"'}
include_graphics("../img/predictive_ecology_logo.png")
```
```{r printingb, eval=knittingToPDF, echo=FALSE, out.width='400px'}
include_graphics("../img/predictive_ecology_logo.png")
```
...
```{r printing2a, eval=knittingToHTML, echo=FALSE,out.extra='style="float:right; margin: 20px; width: 400px"'}
include_graphics("../img/SpaDES opening 1.png")
```
```{r printing2b, eval=knittingToPDF, echo=FALSE, out.width='400px'}
include_graphics("../img/SpaDES opening 1.png")
```
...
```{r printing3a, eval=knittingToHTML, echo=FALSE,out.extra='style="float:right; margin: 20px; width: 400px"'}
include_graphics("../img/Initialize SpaDESUI.png")
```
```{r printing3b, eval=knittingToPDF, echo=FALSE, out.width='400px'}
include_graphics("../img/Initialize SpaDESUI.png")
```
...
```{r printing4a, eval=knittingToHTML, echo=FALSE,out.extra='style="float:right; margin: 20px; width: 400px"'}
include_graphics("../img/SpaDESUI output.png")
```
```{r printing4b, eval=knittingToPDF, echo=FALSE, out.width='400px'}
include_graphics("../img/SpaDESUI output.png")
```
