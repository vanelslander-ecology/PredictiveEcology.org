...
From @sec-castorEg onwards, we show project flows with SpaDES modules
that have been developed and used in ecological modelling and
forecating, to answer both research or applied questions. We encourage
...
We sometimes represent these as hexes, following the R-package convention:

![Hexes](assets/img/Hexes.png)
