...
This will create a new folder with several files in it. See `?newModule`
...
-   See `?defineModule` for all the metadata items. Specifically, see
    `reqdPkgs`.
...
See also: `?expectsInput`, `?createsOutput`, `?simInitAndSpades`,
`?newModule`
