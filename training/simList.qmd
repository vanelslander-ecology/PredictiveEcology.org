...
1. using `simInit()` creates a `simList` object.
2. using `spades()`, which returns a modified `simList` object.
...
2. What do each of these slots contain? Hint: see [`?.simList-class`](https://rdocumentation.org/packages/SpaDES.core/versions/2.0.5/topics/simList-class)
