...
- [Caching](@sec-caching) -- This is a general tool that many
people will be somewhat familiar with. 
- [`reproducible::prepInputs`](@sec-prepInputs) -- a "do-it-all" function for *getting data into
shape*.
- [Debugging](@sec-debugging) -- for general R and specific SpaDES situations.
