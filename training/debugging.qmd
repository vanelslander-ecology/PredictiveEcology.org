...
insert a `browser()` in the `init` event, save and run the module again.
...
not try right-clicking the RStudio window and selecting "Reload") and
the R console shows:
...
-   What happened in step 6. this time?
...
[`?showMethods()`](https://www.rdocumentation.org/packages/methods/versions/3.6.2/topics/showMethods) -- useful to find out what methods of a function
you may want to activate debugging for

An example of debugging a more complex SpaDES workflow in @sec-LandRdebug
