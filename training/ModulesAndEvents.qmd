...
-   Data preparation modules may have:
    ...
    -   one (maybe just the "init" event) or few events and their
        primary goal is to get and deal with data
    -   Do GIS operations
...
-   Dynamic modules
    ...
    -   modules that use explicit iterations or time and whose inputs
        can vary each time
