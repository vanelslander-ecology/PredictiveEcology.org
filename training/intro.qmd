...
facilitate the building of *nimble workflows* for science-based problems that follow in the
principles of repeatability, reproducibility, reusability and
transparency (**R^3^T**). We present these using the **SpaDES** family of 
packages.
