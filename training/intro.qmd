...
(re-)using highly **modular** code that has **metadata** attached.
...
the **Methods** section: i.e., these describe how you will do something.
The use of packages in this way has massively accelerated Ecology and
other data sciences. However, even if you know all the functions that a
paper used, it doesn't create the Results. *SpaDES modules can be
thought of as the code needed to make the **Results**.* In other words,
SpaDES enables us to bundle the actual code needed to recreate all the
steps to make the Results.
