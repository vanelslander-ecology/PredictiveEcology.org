...
It can be very challenging to fulfill these expectations. SpaDES aims to
...
::: {#note-PERFICT .callout-note appearance="simple" icon="false"}
## PERFICT
...
principles (@note-PERFICT), better meet the expectations, and better
