...
Restart R after doing the above. Try the package installations again. If
they fail again, see other solutions and try them.
...
mechanisms. If a package can't be found, or there is an
unexplainable installation failure clearing the package cache may fix it.
