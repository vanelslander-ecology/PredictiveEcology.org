...
The objective of a reproducible workflow is likely that an entire work
...
4. Don't cache a `simInit` call -- instead implement internal caching in the modules
   and use event caching. See [`vignette(topic = "iii-cache", package = "SpaDES.core")`](https://rdrr.io/cran/SpaDES.core/f/vignettes/iii-cache.Rmd)
   
## See also

[`SpaDES.core` vignette on caching](https://rdrr.io/cran/SpaDES.core/f/vignettes/iii-cache.Rmd)
