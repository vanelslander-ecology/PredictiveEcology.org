...
There are several objects stored on Google Drive. You *must* be authenticated to access these. There are several ways to get authenticated. Some work for some people, others don't. This seems to work for many.
