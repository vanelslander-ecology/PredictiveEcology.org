...
outValid <- setupProject(
  ...
  rasterToMatch = {
    list.files(SpaDES.core::inputPath(simOut), "rasterToMatch_LandRDemo_coreVeg", full.names = TRUE) |>
      terra::rast()
  },
  rawBiomassMapStart = {
    list.files(SpaDES.core::inputPath(simOut), "rawBiomassMap_LandRDemo_coreVeg", full.names = TRUE) |>
      terra::rast()
  },
  simulationOutputs = {
  ...
  speciesLayersStart = {
    list.files(SpaDES.core::outputPath(simOut), "speciesLayers_2001_LandRDemo_coreVeg.tif", 
               full.names = TRUE) |>
      terra::rast()
  },
  standAgeMapStart = {
    list.files(SpaDES.core::inputPath(simOut), "standAgeMap_LandRDemo_coreVeg", full.names = TRUE) |>
      terra::rast()
  }
)
